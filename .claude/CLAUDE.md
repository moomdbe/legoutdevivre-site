...
**Question ouverte cabinet physique vs distance uniquement** : toujours pas tranchée côté utilisateur (impacte SEO local vs à distance) — et maintenant plus urgente : la session "Chantiers annexes" a trouvé un profil **Therapeutes.com** déjà existant qui affiche une adresse physique "231 Rue Marcadet, 75018, Paris", alors que legoutdevivre.co ne positionne que le téléphone. Incohérence à résoudre avec l'utilisateur (vrai cabinet en plus du téléphone, ou info à faire retirer de Therapeutes.com) — voir aussi section Annuaires ci-dessus.
